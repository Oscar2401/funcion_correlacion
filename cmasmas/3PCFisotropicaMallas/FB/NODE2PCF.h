...
class NODE2PCF{
	...
	public:
		...
		NODE2PCF(int _bn, int _n_pts, float _size_box, float _size_node, float _d_max, Point3D *_dataD, Node ***_nodeD){
			bn = _bn;
			n_pts = _n_pts;
			size_box = _size_box;
...
void NODE2PCF::make_nodos(Node ***nod, Point3D *dat){
	/*
...
void NODE2PCF::add(Point3D *&array, int &lon, float _x, float _y, float _z){
	lon++;
...
void NODE2PCF::make_histoXX(unsigned int *XX, unsigned int *YY, Node ***nodeX){
	/*
...
//=================================================================== 
void NODE2PCF::histo_front_XX(unsigned int *PP, Node ***dat, float disn, float dn_x, float dn_y, float dn_z, bool con_in_x, bool con_in_y, bool con_in_z, int _row, int _col, int _mom, int _u, int _v, int _w){
	int i, j;
